    ...
    <div class="message activity">
        ...
        <div class="text-display">
            ...
            <div class="message-data">
                ...
                <span class="likes"><span class="like-heart">&hearts;</span><span class="like-count">0</span></span>
            </div>
        </div>
    </div>
</script>
...
<script>
    ...
    function addLike(data) {
       var like= $('div[data-activity-id="'+data.id+'"]').find(".like-count").text();
       $('div[data-activity-id="'+data.id+'"]').find(".like-count").text(parseInt(like)+1);
 
        newLike(data.username);
      
    }
     function newLike(quien) {
        var options = {
    body: quien+" le ha dado like a una publicacion"
